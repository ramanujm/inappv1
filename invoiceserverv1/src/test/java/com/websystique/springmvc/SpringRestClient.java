...
import com.duke.presentation.beans.AuthTokenInfo;
import com.duke.presentation.beans.User;
 
public class SpringRestClient {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/invoiceserverv1";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/invoiceserverv1/oauth/token";
